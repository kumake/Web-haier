			...
			<table id="__01" width="961" height="413" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<table id="__01" width="713" height="413" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td background="images/neiye_gh_01.jpg" width="713" height="37">
							<div  style=" font-size:13px; font-weight:bold; color:#fff; margin-left:12px; padding-top:13px;">
						常见问题
						</div>
							</td>
						</tr>
						<tr>
							<td width="713" height="376">
							<div id="neiye_main">
								<!--内容开始 -->
											  <%
												'''''模型表ID
												...
												'''''模型表名称
												Dim ModelTable:ModelTable ="user_cjwt"
											...
											%>
											  <%
														...
														set rs = UICon.Query("select * from user_cjwt where ID="&ItemID&"")
														UIcon.execute("update user_cjwt set Hots=Hots +1 where id="&ItemID&"")
											  ...
											  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													  ...
													  <table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
														  <td height="35" align="left" valign="middle" class="news_fabutime" style="font-weight: bold">发布时间：<%=rs("posttime")%></td>
															...
															上一篇文章：
																<%
													set rsu = Uicon.query("select top 1 id,categoryid,title from user_cjwt where categoryid="&categoryid&" and id<"&itemid&" order by id desc")
												...
												<tr>
												  <td height="26">下一篇文章：
													<%
													set rsn = Uicon.query("select top 1 id,categoryid,title from user_cjwt where categoryid="&categoryid&" and id>"&itemid&" order by id asc")
